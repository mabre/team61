...
public abstract class Weapon extends Item {
    ...
    private int     mass;       // toggle if gravity affects projectile //ToDo pass this to projectile
     ...
     */
    protected Weapon(String name, String description, int munition, String weaponImg, String projectileImg, int delay, String damagetype, int damage, int explosionpower, int shockwave, boolean poisons, boolean ignites, boolean blocks, int mass, boolean drifts){
